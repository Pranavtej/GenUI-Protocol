import { Component, input, output, model, forwardRef, computed, ViewEncapsulation, ContentChildren, QueryList, AfterContentInit } from '@angular/core';
...
export class GuipSelect implements ControlValueAccessor, AfterContentInit {
  ...
  selectChange = output<string>({alias: 'change'});
